INSERT INTO lms.dbo.Aluno (Id_usuario,Nome,Email,Celular,RA,Foto) 
VALUES (1,'daniel','danielsqlouro@hotmail.com','(11)66954-7550',16855151,NULL)
    , (2,'tiago','tiagobene@hotmai.com','(11)88988-4450',18516112,NULL)
    , (3,'Joao','joaocoddeouro@hotmail.com','(11)88878-7447',15558521,NULL)
    , (4,'ramon','ramoncigarro@hotmail.com','(11)66988-7550',51480558,NULL)
    , (5,'denis','denispcp@hotmail.com','(11)88584-7550',16364861,NULL);

INSERT INTO lms.dbo.Atividade (Titulo,Descricao,Conteudo,Tipo,Extras,IdProfessor) 
VALUES ('SELECTS','Selecionar dados de varias tabelas','TSQL','Teste','faz as juncões necessarias para o select',1)
...
INSERT INTO lms.dbo.AtividadeVinculada (IdAtividade,IdProfessor,IdDisciplinaOfertada,Rotulo,Status,DtInicioRespostas,DtFimRespostas) 
VALUES (1,1,1,'Aberta','Fechada','2018-11-01 00:00:00.000','2018-11-06 00:00:00.000')
    ...
    ,(1,4,4,'Aberta','Aberta','2018-11-01 00:00:00.000','2018-11-01 00:00:00.000')

INSERT INTO lms.dbo.Coordenador (Id_usuario,Nome,Email,Celular)
...
INSERT INTO lms.dbo.Curso (Nome) 
...
INSERT INTO lms.dbo.DisciplinaOfertada (IdCoordenador,DtInicioMatricula,DtFimMatricula,IdDisciplina,IdCurso,ANO,Semestre,Turma,IdProfessor,Metodologia,Recursos,CriterioAvaliacao,PlanoDeAulas) 
VALUES (1,NULL,NULL,1,1,2018,1,'A',1,'Teoria utilizando Aulas expositivas de projetor e lousa eletrônica.','Tecnologia','São aplicadas 10 atividades, uma prova semestral e uma prova substituta caso o aluno precise. ','Apresentação da turma, metodo ações sobre o ambiente, conteúdo programático. Explicar uma VM, acesso ao SQL')
...
INSERT INTO lms.dbo.Entrega (IdAluno,IdAtividadeVinculada,Titulo,Resposta,DtEntrega,Status,IdProfessor,Nota,DtAvaliacao,Obs) 
VALUES (1,1,'Atividade Continua
    ...
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.00,'2018-11-18','Nada declarado
    ')
    ,(1,4,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,2.00,'2018-11-08','Nada declarado
    ')
    ,(1,5,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.00,'2018-11-08','Nada declarado
    ')
    ,(1,6,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,8.00,'2018-11-19','Nada declarado
    ')
    ,(1,7,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,6.00,'2018-11-08','Nada declarado
    ')
    ,(1,8,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.00,'2018-11-08','Nada declarado
    ')
    ,(1,9,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,5.00,'2018-11-08','Nada declarado
    ')
    ...
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,5.00,'2018-11-14','Nada declarado
    ')
    ,(2,2,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,4.00,'2018-11-18','Nada declarado
    ')
    ,(2,3,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,9.00,'2018-11-08','Nada declarado
    ')
    ,(2,4,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,10.00,'2018-11-08','Nada declarado
    ')
    ,(2,5,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.80,'2018-11-16','Nada declarado
    ')
    ,(2,6,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,4.40,'2018-11-08','Nada declarado
    ')
    ,(2,7,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,5.00,'2018-11-24','Nada declarado
    ')
    ,(2,8,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,3.50,'2018-11-16','Nada declarado
    ')
    ,(2,9,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,8.00,'2018-11-08','Nada declarado
    ')
    ,(2,10,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,10.00,'2018-11-12','Nada declarado
    ')
    ,(3,1,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,6.00,'2018-11-08','Nada declarado
    ')
    ,(3,2,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.00,'2018-11-10','Nada declarado
    ')
    ,(3,3,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,8.00,'2018-11-08','Nada declarado
    ')
    ,(3,4,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,8.50,'2018-11-08','Nada declarado
    ')
    ,(3,5,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,9.10,'2018-11-08','Nada declarado
    ')
    ,(3,6,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,4.20,'2018-11-08','Nada declarado
    ')
    ,(3,7,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,5.70,'2018-11-09','Nada declarado
    ')
    ,(3,8,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,6.40,'2018-11-14','Nada declarado
    ')
    ,(3,9,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.10,'2018-11-12','Nada declarado
    ')
    ,(3,10,'Atividade Continua
    ','Não Foi respondido ainda','2018-11-08 21:39:11.000','Entregue',1,7.40,'2018-11-17','Nada declarado
    ');
    
INSERT INTO lms.dbo.Mensagem (IdAluno,IdProfessor,Assunto,Referencia,Conteudo,Status,DtEnvio,DtResposta,Resposta) 
VALUES (1,1,'ac','Professores da faculdadeimpacta','sql','Enviado','2018-11-01 00:00:00.000',NULL,'certo')
...
INSERT INTO lms.dbo.Professor (Id_usuario,Email,Celular,Apelido) 
...
INSERT INTO lms.dbo.SolicitacaoMatricula (IdAluno,IdDisciplinaOfertada,DtSolicitacao,IdCoordenador,Status) 
VALUES (1,1,'2018-11-09 03:58:41.843',1,'Aprovada')
...
INSERT INTO lms.dbo.Usuario (Login,Senha,DtExpiracao) 
VALUES ('daniel','3111986','1900-01-01')
